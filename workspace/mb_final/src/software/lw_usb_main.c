...
//	XIntc_Start(&Intc, XIN_REAL_MODE);
	...
	XTmrCtr_SetResetValue(&Usb_timer,1,14000000); // 8000000
...
//				xil_printf("\n");
				if(kbdbuf.keycode[0]==79){
					...
					if(can_decrease_sun(PEA_SHOOTER_COST)){
					...
					if(can_decrease_sun(SUN_FLOWER_COST)){
					...
					if(can_decrease_sun(PEPPER_COST)){
