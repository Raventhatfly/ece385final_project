...
HD_PWD='D:/ZJUI/ECE385/labs/final/final_project/final_project.runs/mb_lab7_microblaze_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_lab7_microblaze_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_lab7_microblaze_0_0.tcl
